...
#
# Force the pure-Python backend so passlib does NOT import stdlib
# `crypt` internally (its default `os_crypt` backend wraps it and
# inherits the deprecation warning we're trying to escape).
